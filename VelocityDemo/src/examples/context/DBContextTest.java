 ...
 * 
 * tests the DBContext example by putting a string and a hashtable into the context and then rendering a simple template with it.
 * 
...
public class DBContextTest {
    ...
    public static void main(String[] args) {
        String templateFile = "WebRoot\\WEB-INF\\templates\\dbtest.vm";
        try {
